...
\makeatother
	...
	\PY{c}{\PYZsh{} Load the required packages}
        ...
        \PY{c}{\PYZsh{} QP has 113 bits of precision}
        ...
        \PY{k}{function}\PY{n+nf}{ }\PY{n+nf}{rope}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{n}{x}\PY{p}{)}
            ...
            \PY{n}{Fx} \PY{o}{=} \PY{n}{parse}\PY{p}{(}\PY{n}{BigFloat}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{0.4}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
            ...
            \PY{n}{cDiag} \PY{o}{=} \PY{p}{[}\PY{n}{one}\PY{p}{(}\PY{n}{BigFloat}\PY{p}{)}\PY{p}{;}
                \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{ones}\PY{p}{(}\PY{n}{BigFloat}\PY{p}{,}\PY{n}{n}\PY{o}{\PYZhy{}}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{;}
                \PY{l+m+mi}{3}\PY{o}{*}\PY{n}{one}\PY{p}{(}\PY{n}{BigFloat}\PY{p}{)}\PY{p}{]}\PY{p}{;}
            ...
            \PY{k}{return} \PY{p}{[}\PY{n}{x}\PY{p}{[}\PY{n}{n}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{:}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{n}\PY{p}{]}\PY{p}{,}\PY{n}{C}\PY{o}{*}\PY{n}{v} \PY{o}{+} \PY{n}{D}\PY{o}{*}\PY{n}{u}\PY{p}{]}\PY{p}{;}
        \PY{k}{end}
        
        \PY{c}{\PYZsh{} Set up the initial conditions}
        \PY{n}{t0} \PY{o}{=} \PY{n}{zero}\PY{p}{(}\PY{n}{BigFloat}\PY{p}{)}\PY{p}{;}
        \PY{n}{T} \PY{o}{=} \PY{n}{parse}\PY{p}{(}\PY{n}{BigFloat}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{3.723}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
        \PY{n}{x0} \PY{o}{=} \PY{n}{zeros}\PY{p}{(}\PY{n}{BigFloat}\PY{p}{,}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{n}\PY{p}{)}\PY{p}{;}
        
        \PY{c}{\PYZsh{} Set the tolerance }
        ...
        \PY{p}{(}\PY{n}{t\PYZus{}rope}\PY{p}{,}\PY{n}{x\PYZus{}tmp\PYZus{}rope}\PY{p}{)} \PY{o}{=} \PY{n}{ode78}\PY{p}{(}\PY{n}{rope}\PY{p}{,}\PY{n}{x0}\PY{p}{,}\PY{p}{[}\PY{n}{t0}\PY{p}{;}\PY{n}{T}\PY{p}{]}\PY{p}{;}
        \PY{n}{reltol}\PY{o}{=}\PY{n}{Tol}\PY{p}{,}\PY{n}{abstol}\PY{o}{=}\PY{n}{Tol}\PY{p}{,}\PY{n}{points}\PY{o}{=}\PY{p}{:}\PY{n}{specified}\PY{p}{)}\PY{p}{;}
        
        \PY{n}{x\PYZus{}ref} \PY{o}{=} \PY{n}{Array}\PY{p}{\PYZob{}}\PY{n}{BigFloat}\PY{p}{\PYZcb{}}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{;}
        
        \PY{n}{x\PYZus{}ref}\PY{p}{[}\PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{x\PYZus{}tmp\PYZus{}rope}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{n}{n}\PY{p}{]}\PY{p}{;}
        
        \PY{n}{save}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{refSolRope.jld}\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{x\PYZus{}ref}\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{n}{x\PYZus{}ref}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
